...
import com.javarush.akhundov.animals.herbivores.Herbivore;
import com.javarush.akhundov.animals.predators.Predator;
...
import com.javarush.akhundov.plants.Plant;
import com.javarush.akhundov.utility.ClassFinder;
...
public class InitializationService{
    ...
    private HashSet<Class<?>> setClassList(){
        ...
        String HERBIVORES = "com.javarush.akhundov.animals.herbivores";
        tempAnimalsSet = ClassFinder.find(HERBIVORES);
        tempAnimalsSet.remove(Herbivore.class);
        String PREDATORS = "com.javarush.akhundov.animals.predators";
