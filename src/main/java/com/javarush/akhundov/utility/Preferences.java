package com.javarush.akhundov.utility;

import com.javarush.akhundov.animals.herbivores.*;
import com.javarush.akhundov.animals.predators.*;
...
public class Preferences {
    ...
    public java.util.HashMap<Class<?>, java.util.HashMap<Class<?>, Integer>> getPercentageMap() {
